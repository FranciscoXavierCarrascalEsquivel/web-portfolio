...
export default function ContactSection({ title, subtitle, form, placeholders }: ContactSectionProps) {
    ...
    hover:border-gray-700 text-sm
  `;

    const labelClasses = "block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-0.5 ml-1";
            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
                    ...
                    <MotionWrapper useScroll delay={0.3} className="relative group w-full max-w-2xl mx-auto lg:mx-0">
                        ...
                        <div className="relative bg-black/40 backdrop-blur-xl border border-gray-800/50 rounded-2xl p-5 md:p-6 shadow-2xl">
